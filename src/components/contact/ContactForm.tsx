...
export function ContactForm() {
  ...
  return <form id="formulario-contato" autoComplete="off" onSubmit={submit} className="rounded-2xl border border-white/10 bg-[#0b111e]/80 p-5 shadow-2xl backdrop-blur sm:p-7">
