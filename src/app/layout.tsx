...
import "./globals.css";
import { KonamiSealRain } from "@/components/easter-eggs/KonamiSealRain";
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="pt-BR" className={geist.variable}><body><a className="skip-link rounded-md bg-white px-4 py-3 text-sm font-semibold text-slate-950" href="#conteudo-principal">Pular para o conteúdo principal</a>{children}<KonamiSealRain /></body></html>; }
